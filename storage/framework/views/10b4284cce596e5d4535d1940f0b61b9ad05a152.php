    ...
    <body class="signin-page">
        ...
        <div class="mn-content valign-wrapper">
            <main class="mn-inner container">
                <div class="valign">
                      <div class="row">
                          <div class="col s12 m6 l8 offset-l2 offset-m1">
                              <div class="card white darken-1">
                                  <div class="card-content ">
                                      <span class="card-title center-align">
                                       ...
                                       <div class="row">
                                           <form class="col s12" action="<?php echo e(route('login')); ?>" method="POST">
                                                <?php echo e(csrf_field()); ?>

                                               <div class="input-field  col s12">
                                                   <input name="username" type="text" class="validate <?php echo e($errors->has('username') ? ' invalid' : ''); ?>" 
                                                          value="<?php echo e(old('username')); ?>">
                                                   <label for="username" data-error="<?php echo e($errors->first('username')); ?>">Username</label>
                                               </div>
                                               <div class="input-field col s12">
                                                   <input name="password" type="password" class="validate <?php echo e($errors->has('password') ? ' invalid' : ''); ?>" 
                                                          value="">
                                                   <label for="password" data-error="<?php echo e($errors->first('password')); ?>">Password</label>
                                               </div>
                                               <div class="col s12 right-align m-t-sm">
                                                   <a href="<?php echo e(route('register')); ?>" class="waves-effect waves-grey btn-flat">sign up</a>
