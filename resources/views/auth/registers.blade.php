                                   ...
                                   <div class="row">
                                       <form class="col s12" method="POST" action="{{ route('register') }}">
                                           ...
                                           <div class="input-field col s12">
                                               <input name="username" type="text" class="validate {{ $errors->has('username') ? ' invalid' : '' }}" 
                                                      value="{{ old('username') }}">
                                           ...
                                           <div class="input-field col s12">
                                               <input name="name" type="text" class="validate {{ $errors->has('name') ? ' invalid' : '' }}" 
                                                      value="{{ old('name') }}">
                                               <label for="name">Name</label>
                                           </div>
                                           <div class="input-field col s12">
                                               <input name="password" type="password" class="validate  {{ $errors->has('password') ? ' invalid' : '' }}" 
                                                      value="{{ old('password') }}">
                                               <label for="password">Password</label>
                                           </div>
                                           <div class="input-field col s12">
                                               <input name="password_confirmation" id="password_confirmation" type="password" class="validate  {{ $errors->has('password_confirmation') ? ' invalid' : '' }}" 
                                                      value="{{ old('password_confirmation') }}">
                                               <label for="password_confirmation">Confirm Password</label>
                                           </div>
                                           <div class="col s12 right-align m-t-sm">
                                               <a href="{{ url('login') }}" class="waves-effect waves-grey btn-flat">Sign in</a>
